...
//
//    public <K, V> MapComprehension<K, V> map(Class<TYPE> clz, F.Func1... mappers) {
//        return map(mappers);
//    }
//
//    public <TYPE> MapComprehension<TYPE> map(final F.Func1... mappers) {
...
//    }
//
//    public <TYPE> MapComprehension<TYPE> map2(Class<TYPE> cls, final F.Func2... mappers) {
//        return map2(mappers);
//    }
//
//    public <TYPE> MapComprehension<TYPE> map2(final F.Func2... mappers) {
//        final Iterator<? extends V> it = itr.iterator();
//        return new MapComprehension<TYPE>(new Itr<TYPE>() {
//            @Override
//            public Iterator<TYPE> iterator() {
...
//    }
//
//    public <TYPE> MapComprehension<TYPE> apply(Class<TYPE> clz, F.Func1... mappers) {
//        return apply(mappers);
//    }
//
//    public <TYPE> MapComprehension<TYPE> apply(final F.Func1... mappers) {
//        MapComprehension<TYPE> lc = map(mappers);
//        return lc.walkthrough();
//    }
//
//    public <TYPE> MapComprehension<TYPE> apply2(Class<TYPE> cls, final F.Func2... mappers) {
//        return apply2(mappers);
//    }
//
//    public <TYPE> MapComprehension<TYPE> apply2(final F.Func2... mappers) {
//        MapComprehension<TYPE> lc = map2(mappers);
//        return lc.walkthrough();
//    }
//
//    public boolean all(final F.Func1<Boolean, V> test) {
//        return and(test);
//    }
//
//    public boolean any(final F.Func1<Boolean, V> test) {
//        return or(test);
//    }
//
//    public MapComprehension<V> filter(final F.Func1<Boolean, V>... filters) {
//        return filter(C1.list(filters));
//    }
//
//    public MapComprehension<V> filter(final List<F.Func1<Boolean, V>> filters) {
//        switch (filters.size()) {
//            case 0:
//                return this;
//            case 1:
...
//    }
//
//    private MapComprehension<V> filter_(F.Func1<Boolean, V> filter) {
//        List<V> l = C1.newJavaList();
//        accept(F.guardedVisitor(filter, C1.f.addTo(l)));
//        return valueOf(l);
//    }
//
//    public MapComprehension<V> filterOnIndex(F.Func1<Boolean, Integer> filter) {
//        List<V> l = C1.newJavaList();
...
//    }
//
//    public <E> E reduce(final E initVal, final F.Func2<E, V, E> func2) {
//        return MapComprehension.reduce(initVal, this, func2);
//    }
//
//    public static <E, V> E reduce(final E initVal, final MapComprehension<V> lc, final F.Func2<E, V, E> func) {
//        E v = initVal;
...
//    }
//
//    public V reduce(final F.Func2<V, V, V> func2) {
//        return MapComprehension.reduce(this, func2);
//    }
//
//    public static <V> V reduce(final MapComprehension<V> lc, final F.Func2<V, V, V> func) {
//        Iterator<V> itr = lc.iterator();
//        if (!itr.hasNext()) {
//            return null;
//        }
...
//    }
//
//    public final boolean or(final F.Func1<Boolean, V> test) {
//        return !and(_.f.not(test));
//    }
//
//    public final boolean and(final F.Func1<Boolean, V> test) {
...
//    }
//
//    public V first(final F.Func1<Boolean, V> cond) {
...
//    }
//
//    public <E> E first(final F.Func1<Boolean, V> cond, final F.Transformer<V, E> transformer) {
...
//
//    /**
//     * Alias of {@link #accept(org.osgl.util.F.Func1)}
//     *
//     * @param visitor
//     */
//    public void each(F.Func1<?, V> visitor) {
//        accept(visitor);
//    }
//
//    /**
//     * Alias of {@link #accept(org.osgl.util.F.Func2)}
//     *
//     * @param visitor
//     */
//    public void each(F.Func2<?, Integer, V> visitor) {
//        accept(visitor);
//    }
//
//    public void accept(F.Func1<?, V> visitor) {
...
//    }
//
//    public void accept(F.Func2<?, Integer, V> visitor) {
