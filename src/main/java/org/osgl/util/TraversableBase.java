...
TraversableBase<T> extends FeaturedBase implements C.Traversable<T> {
     ...
     * {@link org.osgl.Lang#iterableHashCode(Iterable)} to generate the hash code
     *
     ...
     * If the traversal is empty then return {@link org.osgl.Lang.Option#NONE},
     * otherwise an {@link org.osgl.Lang.Option} wrapping the accumulated result
     * is returned
     *
     * @param accumulator the function the combine two values
     ...
     * then {@link org.osgl.Lang.Option#NONE} is returned
     *
    ...
    public <R> C.Traversable<R> collect(String path) {
        return CollectorTrav.of(this, path);
    }
