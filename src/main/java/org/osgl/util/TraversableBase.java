...
TraversableBase<T> extends FeaturedBase implements C.Traversable<T> {
     ...
     * {@link org.osgl.Osgl#iterableHashCode(Iterable)} to generate the hash code
     *
     ...
     * If the traversal is empty then return {@link org.osgl.Osgl.Option#NONE},
     * otherwise an {@link org.osgl.Osgl.Option} wrapping the accumulated result
     * is returned
     *
     * @param accumulator the function the combine two values
     ...
     * then {@link org.osgl.Osgl.Option#NONE} is returned
     *
